...
Blockly.Blocks['grove_motor_shield'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Motor")
        .appendField(new Blockly.FieldImage("https://www.bananarobotics.com/shop/image/cache/data/sku/BR/0/1/0/0/3/BR010031-Yellow-Gear-Motor-3-6V-120-to-1/Yellow-Gear-Motor-3-6V-120-to-1-600x600.png", 64, 64))

...
Blockly.Arduino.controls_while_repeat = function () {
    var count = window.parseInt(this.getFieldValue('NUM'));
    // Repeat
    var branch = Blockly.Arduino.statementToCode(this, 'DO');
    if (Blockly.Arduino.INFINITE_LOOP_TRAP) {
        branch = Blockly.Arduino.INFINITE_LOOP_TRAP.replace(/%1/g,
    ...
    Blockly.Arduino.definitions_['repeat'] = 'bool repeat=false;';
    Blockly.Arduino.setups_["setup_loop"] =
        "  repeat=true;\n";
    var code="";
    code="if(repeat){\n" +

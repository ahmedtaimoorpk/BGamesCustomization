...
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = 'else if /  ورنہ اگر ';
Blockly.Msg.CONTROLS_IF_MSG_ELSE = 'else / ورنہ ';

Blockly.Msg.CONTROLS_IF_MSG_THEN = 'do/ کرو ';
Blockly.Msg.CONTROLS_IF_IF_TITLE_IF = 'if/اگر';
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = 'Add, remove, or reorder sections\n' +
    'to reconfigure this if block.';
Blockly.Msg.CONTROLS_IF_ELSEIF_TITLE_ELSEIF = 'else if /  ورنہ اگر';

 ...
 */
BlocklyGames.MAX_LEVEL = BlocklyGames.getNumberParamFromUrl('maxLevel', 1, 4);
...
BlocklyGames.loadFromLocalStorage = function(name, level) {
  var xml;
  try {
      // TODO: To make this line work for same user for accessing already done activity. In other words saving XML to database.

...
Scrubber = function (svgParent, opt_changeFunc) {
    ...
    <image xlink:href="messy/icons.png" width="63" height="42" y="3"
    ...
    */
    ...
    <image xlink:href="messy/icons.png" width="63" height="42" y="-20"
...
Scrubber.prototype.nextFrame = function () {
    ...
    this.playPid_ = setTimeout(function () {
        thisScrubber.nextFrame();
    }, delay);
    this.lastFrame_ = now;

...
class londonBoy extends Phaser.Scene {
    ...
    preload() {
        // this.load.tilemapTiledJSON('londonBoyMap','assets/Boy-Rooms/London/temp.json');
        // this.load.image('LBbackground', 'assets/Boy-Rooms/London/London-Boy Blank-Room-01.png');
        this.load.multiatlas('LBSS', 'assets/Boy-Rooms/London/RobotBoyLondon_SS.json', 'assets/Boy-Rooms/London/');
    }
    ...
    create() {
       ...
       items = this.physics.add.group();
        //Background
        var background = this.add.image(400, 300, 'LBSS', 'London-Boy Blank-Room-01.png').setScale(0.76,0.57);
        ...
        var sd = this.add.sprite(400, 300, graphics.generateTexture());

        // this.physics.arcade.enable(graphics);

    // graphics.setInteractive(rect, event);

        // var map = this.add.tilemap('londonBoyMap');
        // map.tileHeight = 32;
        // map.tileWidth = 32;
        // map.height = 10;
        // map.width = 10;
       ...
       // var sprites = map.createFromObjects('background',1, { key: 'LBbackground' });
       ...
       player = this.physics.add.sprite(60, 530, 'LBSS', 'Boy-Robot/5.png').setScale(0.3);
       ...
       // graphics.setInteractive(rect, player);
       ...
       // sprites2[0].input.enableDrag();
        ...
        // var villain = this.add.sprite(50, 50, 'londonBoyMap', 'background');
        ...
        var upFrames = this.anims.generateFrameNames('LBSS', {
             start: 1, end: 4, zeroPad: 1,
             prefix: 'Boy-Robot/', suffix: '.png'
         });

        var downFrames = this.anims.generateFrameNames('LBSS', {
             start: 5, end: 8, zeroPad: 1,
             prefix: 'Boy-Robot/', suffix: '.png'
         });

        var leftFrames = this.anims.generateFrameNames('LBSS', {
             start: 9, end: 14, zeroPad: 1,
             prefix: 'Boy-Robot/', suffix: '.png'
         });

        var rightFrames = this.anims.generateFrameNames('LBSS', {
        ...
        this.anims.create({
            key: 'stop',
            frames: [ { key: 'LBSS', frame: 'Boy-Robot/5.png' } ],
            frameRate: 20
        });
